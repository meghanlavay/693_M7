                    ...
                    <Card.Text>
                        <Container fluid>
                            <form name="employeeUpdate" onSubmit={this.handleSubmit}>
                                ...
                                <Row>
                                    <Col md={2}>Name:</Col>
                                    <Col md="auto"><input type="text" name="name" defaultValue={this.state.employee._name}  /></Col>
                                </Row>
                                <Row>
                                    <Col md={2}>Extension</Col>
                                    <Col md="auto"><input type="text" name="extension" defaultValue={this.state.employee._extension} /></Col>
                                </Row>
                                <Row>
                                    <Col md={2}>Email:</Col>
                                    <Col md="auto"><input type="text" name="email" defaultValue={this.state.employee._email}  /></Col>
                                </Row>
                                <Row>
                                    <Col md={2}>Title:</Col>
                                    <Col md="auto"><input type="text" name="title" defaultValue={this.state.employee._title} /></Col>
                                </Row>
                                <Row>
                                    <Col md={2}>Date Hired:</Col>
                                    <Col md="auto"><input type="text" name="dateHired" readOnly="readOnly" defaultValue={this.state.employee._dateHired}/></Col>
                                </Row>
                                <Row>
                                    <Col md={2}>Currently Employed:</Col>
                                    <Col md="auto"><input type="checkbox" name="currentlyEmployed" defaultChecked={this.state.employee._currentlyEmployed} /></Col>
                                </Row>
