...
import { Badge, Button, Table, Card, Modal, ModalHeader } from 'react-bootstrap'
...
class EmployeeRow extends React.Component {
    ...
    render() {
        return (
            <tr>
                <td><Link to={`/edit/${props.employee._id}`}>
                ...
                <td>
                    <Button variant="danger" size="sm" onClick={onDeleteClick}>X</Button>
